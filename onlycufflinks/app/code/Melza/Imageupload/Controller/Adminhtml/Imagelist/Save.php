...
class Save extends Action
{
     ...
     * Image factory
     *
     * @var \Melza\Imageupload\Model\ImageFactory
     */
     ...
     * @param \Melza\Imageupload\Model\ImageFactory $imageFactory
    ...
    public function __construct(
        ...
        \Melza\Imageupload\Model\ImageFactory $imageFactory,
    ...
    public function execute()
    {
        ...
        try {
            ...
            $resultRedirect->setPath('melza/imagelist');
        } catch (\Exception $e) {
            $this->messageManager->addError($e->getMessage());
            $this->_getSession()->setImageData($data);

            $resultRedirect->setPath('melza/imagelist/edit', ['image_id' => $id]);
        }
