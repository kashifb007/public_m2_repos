...
class ReferActions extends Column
{
    ...
    public function __construct(
        ...
        array $components = [],
        array $data = [],
        $editUrl = self::REFER_URL_PATH_EDIT
    ) {
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['refer_id'])) {
                    $item[$name]['edit'] = [
                        'href' => $this->urlBuilder->getUrl($this->editUrl, ['refer_id' => $item['refer_id']]),
                        'label' => __('Edit')
                    ];
                    $item[$name]['delete'] = [
                        'href' => $this->urlBuilder->getUrl(self::REFER_URL_PATH_DELETE, ['refer_id' => $item['refer_id']]),
                        'label' => __('Delete'),
                        'confirm' => [
